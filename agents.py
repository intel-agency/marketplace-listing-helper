...
# Initialize JobSpyTools with hybrid mode (Apify + custom scraper failover)
# Set APIFY_API_TOKEN env var to enable Apify; otherwise uses custom scraper only
spy_tools = JobSpyTools(
    apify_token=os.environ.get("APIFY_API_TOKEN"),
    use_hybrid_mode=True,  # Enable automatic failover
)
